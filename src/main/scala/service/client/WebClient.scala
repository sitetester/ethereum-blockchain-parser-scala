...
case class GetLogRequest(jsonrpc: String, method: String, params: Array[EventLogRequestParams], id: Int)
...
case class Transaction(blockHash: String, blockNumber: String, from: String, to: String, hash: String, transactionIndex: String)

case class Block(difficulty: String, hash: String, number: String, transactions: Array[Transaction], var eventLogs: Array[EventLog])

case class BlockByNumberResponse(jsonrpc: String, id: Int, result: Block)

class WebClient {
  val REMOTE_URL = "https://mainnet.infura.io/v3/ae2f42cad8de499ca2cd734e5a5affe5"
  ...
  def getBlockByNumber(blockNumber: Int): Block = {
    ...
    val blockByNumberRequest = BlockByNumberRequest("2.0", "eth_getBlockByNumber", Array("0x5BAD55", true), 1)
